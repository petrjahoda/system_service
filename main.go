...
const config = "user=root password=admin dbname=systemik host=localhost port=26257 sslmode=disable application_name=system_service"
const postgresConfig = "user=root password=admin dbname=postgres host=localhost port=26257 sslmode=disable application_name=system_service"
